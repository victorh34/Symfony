...
class __TwigTemplate_9bc2067669a5f1c01bed365343cb8883bc2081c552f3c20c2a512b3469eb26ce extends Twig_Template
{
...
";
  ...
  <p>
    ...
    <a href=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("oc_platform_edit", array("id" => $this->getAttribute(($context["advert"] ?? null), "id", array()))), "html", null, true);
        echo "\" class=\"btn btn-default\">
    ...
    <a href=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("oc_platform_delete", array("id" => $this->getAttribute(($context["advert"] ?? null), "id", array()))), "html", null, true);
...
{% endblock %}", "OCPlatformBundle:Advert:view.html.twig", "/Users/iVic/Desktop/Projets/PHP/Symfony/src/OC/PlatformBundle/Resources/views/Advert/view.html.twig");
    }
}
